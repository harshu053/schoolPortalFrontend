  ...
  const renderIcons = () => {
    switch (iconName) {
      ...
      case "IcLogout":
        return (
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M17.87 3.91a1 1 0 00-1.58.966 1 1 0 00.4.654 8 8 0 11-9.38 0 1.002 1.002 0 00-1.18-1.62 10 10 0 1011.74 0zM12 8a1 1 0 001-1V3a1 1 0 00-2 0v4a1 1 0 001 1z" fill="currentColor">
            </path>
          </svg>
        );
      case 'RILLogo':
      ...
      case "IcAnalytics":
        return (
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M14 11h8a10 10 0 00-9-8.95v8a1 1 0 001 .95zm-3-1V2.05A10 10 0 1022 13h-8a3 3 0 01-3-3z" fill="currentColor"></path>
          </svg>
        );
      ...
      case 'IcCompoundInterest':
        return (
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M20 19H5v-1.91h1.18c7 0 10.16-4.08 12.68-9.39l.19.58A1 1 0 0020 9c.106.014.214.014.32 0A1 1 0 0021 7.68l-1-3a1 1 0 00-1.27-.63l-3 1A1.019 1.019 0 1016.32 7l.84-.28C14.68 12 11.86 15.53 5 15.07V4a1 1 0 00-2 0v16a1 1 0 001 1h16a1 1 0 000-2z" fill="currentColor"></path>
          </svg>
        );
      case 'IcAnalyticsPieChartTwo':
        return (
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M19.72 5.66l-3.57 3.57a5 5 0 11-8.35 0L4.23 5.66a10 10 0 1015.49 0zm-5 2.16l3.58-3.57a10 10 0 00-12.65 0l3.57 3.57a5 5 0 015.51 0h-.01z" fill="currentColor"></path>
          </svg>
        );
      case 'IcGraphIncreasing':
        return (
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13 14h-2a1 1 0 00-1 1v5a1 1 0 001 1h2a1 1 0 001-1v-5a1 1 0 00-1-1zm6-2h-2a1 1 0 00-1 1v7a1 1 0 001 1h2a1 1 0 001-1v-7a1 1 0 00-1-1zM7 16H5a1 1 0 00-1 1v3a1 1 0 001 1h2a1 1 0 001-1v-3a1 1 0 00-1-1zM19 3h-3a1 1 0 100 2h.59l-3.86 3.86-2.41-.81a1 1 0 00-.94.17l-5 4A1 1 0 005 14a1 1 0 00.62-.22l4.58-3.66 2.48.83a1 1 0 001-.24L18 6.41V7a1 1 0 002 0V4a1 1 0 00-1-1z" fill="currentColor"></path>
          </svg>
        );
      case 'IcInterestLow':
        return (
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M16 16.008a1 1 0 001 1h3a1 1 0 001-1v-3a1 1 0 00-2 0v.59l-3.29-3.3a1.002 1.002 0 00-1.42 0L12 12.588l-7.21-9.2a.7.7 0 00-.16-.13.49.49 0 00-.15-.1.85.85 0 00-.17-.06H4l-.12-.09a.65.65 0 00-.2 0 .66.66 0 00-.19.09h-.11a.7.7 0 00-.13.16.49.49 0 00-.1.15.85.85 0 00-.06.17 1.42 1.42 0 000 .2l-.09.23v16a1 1 0 001 1h16a1 1 0 100-2H5V6.898l6.13 7.81a1 1 0 00.73.38 1 1 0 00.77-.29l2.37-2.38 2.59 2.59H17a1 1 0 00-1 1z" fill="currentColor"></path>
          </svg>
        );
      case 'IcDistribution':
        return (
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M19 10a2 2 0 10-2-2 1.37 1.37 0 000 .19l-3.3 2.35a2.999 2.999 0 00-.72-.36V5.72A2 2 0 0014 4a2 2 0 10-4 0 2 2 0 001 1.72v4.46A3 3 0 009.18 12H6.72A2 2 0 005 11a2 2 0 100 4 2 2 0 001.72-1h2.46a3.1 3.1 0 001.08 1.44l-.75 2.63A2 2 0 1012 20a2 2 0 00-.56-1.39l.75-2.61a2.88 2.88 0 001.33-.41L16 17.66V18a2 2 0 102-2 1.909 1.909 0 00-.68.13L14.81 14c.115-.321.18-.659.19-1a2.76 2.76 0 00-.13-.82l3.31-2.36A2 2 0 0019 10z" fill="currentColor"></path>
          </svg>
        );
      case 'IcGraphTable':
        return (
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M16 17a1 1 0 001-1V6a1 1 0 00-2 0v10a1 1 0 001 1zm-4 0a1 1 0 001-1v-6a1 1 0 00-2 0v6a1 1 0 001 1zm-4 0a1 1 0 001-1v-4a1 1 0 10-2 0v4a1 1 0 001 1zm12-6a1 1 0 00-1 1v4a1 1 0 002 0v-4a1 1 0 00-1-1zm0 8H5V4a1 1 0 00-2 0v16a1 1 0 001 1h16a1 1 0 000-2z" fill="currentColor"></path>
          </svg>
        );
      case 'IcForms':
        return (
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13.77 3H6.23A3.12 3.12 0 003 6v12a3.12 3.12 0 003.23 3h7.54A3.12 3.12 0 0017 18V6a3.12 3.12 0 00-3.23-3zM7 6h2.5a1 1 0 110 2H7a1 1 0 010-2zm6 12H7a1 1 0 010-2h6a1 1 0 110 2zm0-5H7a1 1 0 010-2h6a1 1 0 110 2zm5.66-9c.284.628.427 1.31.42 2v12a4.749 4.749 0 01-.42 2A2.71 2.71 0 0021 17.28V6.72A2.71 2.71 0 0018.66 4z" fill="currentColor"></path>
          </svg>
        );
      case 'IcCalendar':
        return (
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M18 3h-1a1 1 0 00-2 0H9a1 1 0 00-2 0H6a3 3 0 00-3 3v12a3 3 0 003 3h12a3 3 0 003-3V6a3 3 0 00-3-3zm-4.5 14a1 1 0 01-2 0v-3.59l-.29.3a1.004 1.004 0 11-1.42-1.42l2-2a.999.999 0 011.09-.21 1 1 0 01.62.92v6zM19 7H5V6a1 1 0 011-1h1a1 1 0 002 0h6a1 1 0 002 0h1a1 1 0 011 1v1z" fill="currentColor"></path></svg>
        );
      case 'IcCalendarWeek':
        return (
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M20.12 3.88A3 3 0 0018 3h-1a1 1 0 00-2 0H9a1 1 0 00-2 0H6a3 3 0 00-3 3v12a3 3 0 003 3h12a3 3 0 003-3V6a3 3 0 00-.88-2.12zM8 17a1 1 0 110-2 1 1 0 010 2zm0-4a1 1 0 110-2 1 1 0 010 2zm4 4a1 1 0 110-2 1 1 0 010 2zm0-4a1 1 0 110-2 1 1 0 010 2zm4 0a1 1 0 110-2 1 1 0 010 2zm3-6H5V6a1 1 0 011-1h1a1 1 0 002 0h6a1 1 0 002 0h1a1 1 0 011 1v1z" fill="currentColor"></path></svg>
        );
      case 'IcInfo':
        return (
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2a10 10 0 100 20 10 10 0 000-20zm0 3.5a1.5 1.5 0 110 3 1.5 1.5 0 010-3zm2 12h-4a1 1 0 010-2h1v-3h-1a1 1 0 010-2h2a1 1 0 011 1v4h1a1 1 0 010 2z" fill="currentColor"></path></svg>
        );
      case 'IcUpload':
        return (
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M17 9h-1a1 1 0 100 2h1a1 1 0 011 1v7a1 1 0 01-1 1H7a1 1 0 01-1-1v-7a1 1 0 011-1h1a1 1 0 100-2H7a3 3 0 00-3 3v7a3 3 0 003 3h10a3 3 0 003-3v-7a3 3 0 00-3-3zM9.71 6.71L11 5.41V16a1 1 0 102 0V5.41l1.29 1.3a1 1 0 001.639-.325 1 1 0 00-.219-1.095l-3-3a1 1 0 00-1.42 0l-3 3a1.004 1.004 0 001.42 1.42z" fill="currentColor"></path></svg>
        );
      case 'IcMinus':
        return (
